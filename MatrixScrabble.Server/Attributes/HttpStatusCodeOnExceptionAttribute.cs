...
namespace MatrixScrabble.Server.Attributes
{
    ...
    public class HttpStatusCodeOnExceptionAttribute : ExceptionFilterAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            context.Result = CreateResult(context.HttpContext.Request.Method, statusCode, tuple.Item2);
        ...
        private static IActionResult CreateResult(string requestMethod, HttpStatusCode code, Exception exception)
        {
